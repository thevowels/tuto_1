                ...
                md:max-w-5xl xl:mb-24`}>
                    ...
                    bg-conic-gradient`}>
                        <div className={"relative bg-n-8 rounded-[1rem]"}>
                            ...
                            overflow-hidden md:aspect-[668/490] lg:aspect-[1024/490]`}
                            >
                                <img src={robot}
                                ...
                                <Generating className={`
                                    absolute left-4 right-4 bottom-5 md:left-1/2 md:right-auto
                                    md:bottom-8 md:w-[31rem] md:-translate-x-1/2
                                `}/>
                                <ScrollParallax isAbsolutelyPositioned>
                                    <ul className={`hidden absolute
                                    -left-[5.5rem] bottom-[7.5rem] px-1 py-1 bg-n-9/40 backdrop-blur border border-n-1/10 rounded-2xl xl:flex`}>
